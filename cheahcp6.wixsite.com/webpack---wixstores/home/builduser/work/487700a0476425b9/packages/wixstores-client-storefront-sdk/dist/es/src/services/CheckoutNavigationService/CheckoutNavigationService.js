...
var CheckoutNavigationService = /** @class */ (function() {
    function CheckoutNavigationService(_a) {
        ...
        this.navigateToCheckoutOutViewer = function(checkoutInfo) {
            ...
            var checkoutUrl = getCheckoutOutOfViewerUrl(__assign({
            ...
            }, (checkoutInfo.isPreselectedFlow !== undefined ?
                {
        ...
        return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        {
                            void this.siteStore.platformBiLogger.checkoutShowMerchantPaymentPopupSf(__assign(__assign({}, biParams), {
                                catalogAppId: getCatalogAppIds(cartSummary)
                            }));
    ...
    CheckoutNavigationService.prototype.checkoutInfoToQueryParams = function(checkoutInfo) {
        ...
        return __assign(__assign(__assign(__assign(__assign(__assign({
            ...
            origin: this.origin,
            originType: checkoutInfo.originType
        }, (checkoutInfo.successUrl ? {
            successUrl: checkoutInfo.successUrl
        } : {})), (checkoutInfo.theme ? {
            theme: checkoutInfo.theme
        } : {})), (checkoutInfo.isPickupOnly ? {
            isPickupFlow: checkoutInfo.isPickupOnly
            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        urlParams = __assign({
                            checkoutOOI: 'true'
                        }, (checkoutInfo.disableContinueShopping ? {
