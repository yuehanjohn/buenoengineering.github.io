...
var SiteStore = /** @class */ (function(_super) {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (this.experiments.enabled(SPECS.NavigateToRelativeUrlWithCustomizedUrl)) {
                            this.location.to(this.customUrlApi.buildProductPageRelativeUrl({
                                slug: conf.state
                            }));
                        } else {
    ...
    SiteStore.prototype.getPageLink = function(pageLink) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function() {
            var siteStructure, _d, _e, link, _f;
            return __generator(this, function(_g) {
                switch (_g.label) {
                    ...
                    case 2:
                        return [2 /*return*/ , (_d.sdkLink = (_e.pageId = (_a = (_g.sent())) === null || _a === void 0 ? void 0 : _a.id, _e.type = 'PageLink', _e),
                            _d.url = this.location.baseUrl,
                            _d)];
                    case 3:
                        if (!((_b = siteStructure.pages.find(function(p) {
                                return p.id === pageLink.pageId;
                            })) !== null && _b !== void 0)) return [3 /*break*/ , 4];
                        _f = _b;
                        return [3 /*break*/ , 6];
                    case 4:
                        return [4 /*yield*/ , this.getHomepageStructurePage()];
                    ...
                    case 6:
                        ...
                        return [2 /*return*/ , {
                            sdkLink: {
                                pageId: link === null || link === void 0 ? void 0 : link.id,
                                type: 'PageLink'
                            },
                            url: "" + this.location.baseUrl + ((_c = link === null || link === void 0 ? void 0 : link.url) !== null && _c !== void 0 ? _c : ''),
                        }];
                }
            });
        });
    ...
    SiteStore.prototype.getLink = function(sdkLink) {
        return __awaiter(this, void 0, void 0, function() {
            var link, doubleSlashRegex, pagePath, url;
            return __generator(this, function(_a) {
                ...
                if (this.experiments.enabled(SPECS.FixDynamicLinkHover) && sdkLink.type === 'DynamicPageLink') {
                    doubleSlashRegex = /\/\//g;
                    pagePath = ("/" + this.getUrl(sdkLink)).replace(doubleSlashRegex, '/');
                    url = "" + this.location.baseUrl + pagePath;
                    return [2 /*return*/ , {
                        sdkLink: sdkLink,
                        url: url,
                    }];
