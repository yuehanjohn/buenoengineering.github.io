                    ...
                    switch (_e.label) {
                            ...
                            this.i18n = this._initI18n({
                                ...
                                asyncMessagesLoader: function(locale) {
                                    ...
                                    if (!availableLanguages.has(locale)) {
                                        return Promise.reject(new Error("Locale assets for ".concat(locale, " are not provided")));
                                    }
                                    ...
                                    return fetch("".concat((_a = _this.basePath) !== null && _a !== void 0 ? _a : __webpack_public_path__).concat(_this.localeDistPath, "/").concat(config.prefix, "_").concat(locale, ".json")).then(function(r) {
                                        if (!r.ok) {
                                            return Promise.reject(new Error("Can't load locale: ".concat(config.language)));
                                        }
                                        return r.json();
                                    });
                                },
                        ...
                        case 1:
                            ...
                            if (!translationDataForLanguage &&
                                ...
                                throw new Error("Unexpected missing translations for language ".concat(config.language));
                            }
