                ...
                return __generator(this, function(_b) {
                    switch (_b.label) {
                        ...
                        case 2:
                            ...
                            panoramaClient === null || panoramaClient === void 0 ? void 0 : panoramaClient.reportLoadFinish();
...
export var handleControllerError = function(error, flowAPI, appName, componentName, method) {
    ...
    if (!flowAPI.environment.isEditor) {
        // Currently platform doesn't log errors happened in worker. We want to fix it here.
        console.error("\u2757\uFE0FError \uD83D\uDC49 \"".concat(appName, "\" app \uD83D\uDC49 ").concat(componentName, " controller \uD83D\uDC49 ").concat(method ? "".concat(method, " method") : '', " \u2757\n"), error);
        if (flowAPI.sentry) {
