...
var getWrappedPanelController = function(controllerDescriptor, controllerConfig, flowAPI, optionalDeps) {
    return __awaiter(void 0, void 0, void 0, function() {
        var method, createMethod;
        return __generator(this, function(_a) {
            method = controllerDescriptor.method;
            createMethod = method.createPanelMethod;
            return [2 /*return*/ , createPanelController(controllerConfig, function(config) {
                return __awaiter(void 0, void 0, void 0, function() {
                    var initState, $bind, $bindAll, $w, initedBind, query, editorLanguage, methodResult;
                    var _a, _b;
                    return __generator(this, function(_c) {
                        switch (_c.label) {
                            case 0:
                                ...
                                if (!flowAPI.translations) return [3 /*break*/ , 2];
                                query = config.wixCodeApi.location.query;
                                editorLanguage = query.editorLanguage;
                                if (!(editorLanguage && editorLanguage !== 'en')) return [3 /*break*/ , 2];
...
var getWrappedController = function(controllerDescriptor, controllerConfig, flowAPI, optionalDeps, appData) {
    return __awaiter(void 0, void 0, void 0, function() {
        var urlQueryParams, overridedProps, method, exports, createMethod, EXPORTS, properties, events;
        var _a, _b;
        return __generator(this, function(_c) {
            urlQueryParams = flowAPI.controllerConfig.wixCodeApi.location.query;
            try {
            ...
            properties = EXPORTS.PROPS ?
                Object.keys(EXPORTS.PROPS).map(function(key) {
                    return ({
                        name: key,
            ...
            events = EXPORTS.EVENTS ?
                Object.keys(EXPORTS.EVENTS).map(function(event) {
                    return ({
                        name: event
                    });
                }) :
