...
import {
    getAppData,
    setAppData,
    setViewerScriptFlowAPI,
    setViewerScriptFlowAPIInitPromise,
} from './sharableInstances';
export var initAppForPageWrapper = function(_a) {
    ...
    return function(initParams, platformAPIs, namespaces, platformServices) {
        return __awaiter(void 0, void 0, void 0, function() {
            var viewerScriptFlowAPI, viewerScriptFlowAPIInitPromise, appData, e_1;
                ...
                switch (_a.label) {
                    case 0:
                        viewerScriptFlowAPI = new ViewerScriptFlowAPI({
                            ...
                            platformBI: platformServices.bi,
                            biLoggerFactory: platformServices.biLoggerFactory,
                            essentials: platformServices.essentials,
                        ...
                        setViewerScriptFlowAPI(viewerScriptFlowAPI);
                        viewerScriptFlowAPIInitPromise = viewerScriptFlowAPI.init();
                        setViewerScriptFlowAPIInitPromise(viewerScriptFlowAPIInitPromise);
                    ...
                    case 4:
                        ...
                        if (!inEditor) {
                            ...
                            console.error("\u2757\uFE0FError \uD83D\uDC49 \"".concat(appName, "\" app \uD83D\uDC49 `viewer.app.ts` module \u2757\n"), e_1);
                            viewerScriptFlowAPI.reportError(e_1);
                        }
                        throw e_1;
                    case 5:
                        // appData will be available in controllers
                        return [2 /*return*/ , getAppData()];
                }
            });
        });
    };
};
//# sourceMappingURL=viewerAppWrapper.js.map