...
export var blocksControllerWrapper = function(optionalDeps, controllerDescriptor, controllerConfig, viewerScriptFlowAPI, viewerScriptFlowAPIInitPromise, getAppData) {
    var appData = getAppData();
    var blocksControllerService = optionalDeps.blocksControllerService;
    ...
    var flowAPI = new PlatformControllerFlowAPI({
    ...
    return Promise.all([viewerScriptFlowAPIInitPromise, flowAPI.init()]).then(function() {
        return __awaiter(void 0, void 0, void 0, function() {
            var controller;
            return __generator(this, function(_a) {
                switch (_a.label) {
                    case 0:
                        return [4 /*yield*/ , blocksControllerService.getWrappedController(controllerDescriptor, controllerConfig, flowAPI, optionalDeps, appData)];
                    case 1:
                        controller = (_a.sent());
...
//# sourceMappingURL=blocksControllerWrapper.js.map