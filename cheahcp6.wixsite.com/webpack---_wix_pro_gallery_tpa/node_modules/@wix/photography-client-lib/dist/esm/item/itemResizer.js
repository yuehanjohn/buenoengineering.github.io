...
var getResizeMediaUrl = function(_a) {
    var _b = _a === void 0 ? {} : _a,
        ...
        useOptimizedImageFormat = _b.useOptimizedImageFormat,
        isPrerenderMode = _b.isPrerenderMode;
    return function(args) {
        return resize(__assign(__assign({}, args), {
            imageToken: imageToken,
            staticMediaUrls: staticMediaUrls,
            isPrerenderMode: isPrerenderMode,
            shouldUseOptimizedImageFormat: useOptimizedImageFormat !== null && useOptimizedImageFormat !== void 0 ? useOptimizedImageFormat : true
        }));
    };
};
...
var createResizedImageUrl = function(_a) {
    ...
    if (shouldProccessPrerenderImageForPerformance(isPrerenderMode)) {
        var _d = resizeWidthInStepsUp(requiredWidth, requiredHeight, item, getResizeMediaUrl()),
            nextWidth = _d.nextWidth,
            nextHeight = _d.nextHeight;
    ...
    var _e = limtImageResToMaxRes(requiredWidth, requiredHeight, originalMaxPixels < MAX_WIX_PIXELS ? originalMaxPixels : MAX_WIX_PIXELS),
        maxHeight = _e.maxHeight,
        maxWidth = _e.maxWidth;
...
var resize = function(_a) {
    var item = _a.item,
        ...
        shouldUseOptimizedImageFormat = _a.shouldUseOptimizedImageFormat,
        isPrerenderMode = _a.isPrerenderMode;
    if (!originalUrl)
        return;
    ...
    if (resizeMethod === 'video') {
        ...
        if (shoulduseWowImage({
                createComplexImageElement: createMultiple
            })) {
            return createWowImageData({
                item: item,
                requiredHeight: requiredHeight,
                requiredWidth: requiredWidth,
                resizeMethod: resizeMethod,
...
var createWowImageData = function(_a) {
    var _b, _c;
    var item = _a.item,
        requiredHeight = _a.requiredHeight,
        requiredWidth = _a.requiredWidth,
    ...
    var imageData = {
        ...
        // id: 'image0',
        name: (_c = (_b = item.dto) === null || _b === void 0 ? void 0 : _b.metaData) === null || _c === void 0 ? void 0 : _c.fileName,
...
var resizeImageUrl = function(_a) {
    var createMultiple = _a.createMultiple,
        params = _a.params,
        WIX_MEDIA_PREFIX = _a.WIX_MEDIA_PREFIX,
        shouldUseOptimizedImageFormat = _a.shouldUseOptimizedImageFormat,
        originalUrl = _a.originalUrl,
        hasImageToken = _a.hasImageToken;
    if (createMultiple) {
        ...
        if (!hasImageToken) {
            return __spreadArray([{
                type: getMediaType(originalUrl),
                url: url_1,
                dpr: [1, 2, 3, 4, 5, 6, 7, 8].map(function(i) {
                    return "".concat(url_1, " ").concat(i, "x");
                }).join(', '),
                forPrinting: true,
            }], sources, true);
        }
...
var shoulduseWowImage = function(_a) {
    var createComplexImageElement = _a.createComplexImageElement;
    return (createComplexImageElement &&
        experimentsWrapper.getExperimentBoolean('specs.pro-gallery.useWowImageRenderer'));
};
...
var getResizeMethod = function(_a) {
    var resizeMethod = _a.resizeMethod,
        isPrerenderMode = _a.isPrerenderMode,
        requiredHeight = _a.requiredHeight,
        requiredWidth = _a.requiredWidth;
