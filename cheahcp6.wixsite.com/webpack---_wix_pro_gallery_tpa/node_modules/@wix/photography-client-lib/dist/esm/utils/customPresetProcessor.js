...
export var presets = {
    ...
    1: {
        ...
        desktop: function(styles) {
            ...
            res.imageMargin = 0;
            res.gridStyle = 1;
            res.scrollDirection = GALLERY_v4_CONSTS.scrollDirection.HORIZONTAL;
            res.titlePlacement = 'SHOW_ON_HOVER';
            res.cubeType = GALLERY_v4_CONSTS.cubeType.CROP;
            return res;
        },
    ...
    2: {
        ...
        desktop: function(styles) {
            ...
            res.imageMargin = 5;
            res.gridStyle = 1;
            res.scrollDirection = GALLERY_v4_CONSTS.scrollDirection.VERTICAL;
    ...
    4: {
        ...
        desktop: function(styles) {
            ...
            res.calculateTextBoxWidthMode =
                GALLERY_v4_CONSTS.textBoxWidthCalculationOptions.PERCENT;
    ...
    14: {
        ...
        desktop: function(styles) {
            ...
            res.fixedColumns = 1;
            res.gridStyle = 1;
            res.titlePlacement = GALLERY_v4_CONSTS.placements.ALTERNATE_HORIZONTAL;
            // crop method
            res.cubeType = GALLERY_v4_CONSTS.cubeType.CROP;
            res = assignByString(res, optionsMap.layoutParams.crop.method, 'FILL');
            return res;
        },
        mobile: function(styles) {
            var res = __assign({}, styles);
            ...
            res.titlePlacement = GALLERY_v4_CONSTS.placements.SHOW_BELOW;
            // Crop method
            res.cubeType = GALLERY_v4_CONSTS.cubeType.CROP;
            res = assignByString(res, optionsMap.layoutParams.crop.method, 'FILL');
            // Number of columns
            res.fixedColumns = 1;
            res = assignByString(res, optionsMap.layoutParams.structure.numberOfColumns, 1);
            return res;
        },
    },
    15: {
        ...
        desktop: function(styles) {
            ...
            res = assignByString(res, optionsMap.layoutParams.crop.ratios, [
                1,
                1,
                1,
                1,
            ...
            res = assignByString(res, optionsMap.layoutParams.crop.method, 'FILL');
            res.imageMargin = 20;
            res = assignByString(res, optionsMap.layoutParams.structure.itemSpacing, 20);
            return res;
        },
        mobile: function(styles) {
            var res = __assign({}, styles);
    ...
    16: {
        ...
        desktop: function(styles) {
            ...
            res.fixedColumns = 1;
            // Crop ratio
            res = assignByString(res, 'layoutParams_cropRatio', 1.5);
            res = assignByString(res, optionsMap.layoutParams.crop.ratios, [1.5]);
            // Item spacing
            res.imageMargin = 80;
            res = assignByString(res, optionsMap.layoutParams.structure.itemSpacing, 80);
            res.gridStyle = 1;
            res.titlePlacement = GALLERY_v4_CONSTS.placements.ALTERNATE_HORIZONTAL;
            // Crop method
            res.cubeType = GALLERY_v4_CONSTS.cubeType.CROP;
    ...
    17: {
        ...
        desktop: function(styles) {
            ...
            res.cubeImages = true;
            // Crop Methos
            res.cubeType = GALLERY_v4_CONSTS.cubeType.FIT;
            res = assignByString(res, optionsMap.layoutParams.crop.method, 'FIT');
            // Crop ratio
            res = assignByString(res, 'layoutParams_cropRatio', 0.5);
            res = assignByString(res, optionsMap.layoutParams.crop.ratios, [0.5]);
            res.titlePlacement = GALLERY_v4_CONSTS.placements.SHOW_BELOW;
            res.scrollDirection = 1;
            res.cubeFitPosition = GALLERY_v4_CONSTS.cubeFitPosition.BOTTOM;
            return res;
        },
        mobile: function(styles) {
            var res = __assign({}, styles);
            res.hoveringBehaviour = GALLERY_v4_CONSTS.infoBehaviourOnHover.NEVER_SHOW;
            res.scrollDirection = 1;
            res.galleryMargin = 0;
            res.isVertical = true;
            res.groupSize = 1;
            ...
            res = assignByString(res, optionsMap.layoutParams.crop.method, 'FIT');
            // Crop ratio
            res = assignByString(res, 'layoutParams_cropRatio', '100%/100%');
            res = assignByString(res, optionsMap.layoutParams.crop.ratios, [
                '100%/100%',
            ]);
            // Info placement
            res.titlePlacement = GALLERY_v4_CONSTS.placements.SHOW_BELOW;
            res = assignByString(res, optionsMap.layoutParams.info.placement, 'BELOW');
            return res;
        },
    },
};
