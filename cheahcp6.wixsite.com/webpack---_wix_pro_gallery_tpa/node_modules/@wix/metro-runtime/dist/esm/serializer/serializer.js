    ...
    return function serialize(json = {}, converterType) {
        ...
        function transformSchema(schema, payload) {
            ...
            Object.entries(payload).forEach(([key, val]) => {
                ...
                const isRepeatable = (_c = (_b = (_a = getConverter(schemaName)) === null || _a === void 0 ? void 0 : _a.checkRepetable) === null || _b === void 0 ? void 0 : _b.call(_a, val)) !== null && _c !== void 0 ? _c : Array.isArray(val);
                let parsedValue;
                if (isRepeatable) {
