(function webpackUniversalModuleDefinition(root, factory) {
    ...
    ([
        ...
        (function(module, exports, __webpack_require__) {
            ...
            (function(global) { // Best place to find information on XHR features is:
        ...
        (function(module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony export (binding) */
            __webpack_require__.d(__webpack_exports__, "getVideoURLs", function() {
                return getVideoURLs;
            });
            /* harmony export (binding) */
            __webpack_require__.d(__webpack_exports__, "getVideoMetadata", function() {
                return getVideoMetadata;
            });
            /* harmony export (binding) */
            __webpack_require__.d(__webpack_exports__, "getVideoId", function() {
                return getVideoId;
            });
            /* harmony export (binding) */
            __webpack_require__.d(__webpack_exports__, "getVideoImage", function() {
                return getVideoImage;
            });
            /* harmony import */
            var nanoajax__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__( /*! nanoajax */ 0);
            /* harmony import */
            var nanoajax__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/ __webpack_require__.n(nanoajax__WEBPACK_IMPORTED_MODULE_0__);
            ...
            var getAdaptiveSource = function(adaptiveInfo) {
                if (adaptiveInfo === void 0) {
                    adaptiveInfo = [];
                }
                return adaptiveInfo.map(function(info) {
                    return ({
            ...
            var getProgressiveSource = function(videoInfo) {
                ...
                return videoInfo.map(function(info) {
                    return ({
                        type: info.format.toUpperCase(),
            ...
            var getVideoURLs = function(idOrInfo) {
                ...
                return promise.then(function(info) {
                    return __spreadArrays(getProgressiveSource(info.file_output.video), getAdaptiveSource(info.file_output.adaptive_video));
                });
            };
            /**
            ...
            var getVideoMetadata = function(idOrInfo) {
                var promise = typeof idOrInfo === 'object' ?
                    ...
                    getInfo(idOrInfo);
                return promise.then(function(info) {
                    return (__assign(__assign({}, info.file_input), {
                        size: info.file_size
                    }));
                });
            };
            ...
            var getVideoImage = function(id, options) {
                var _a = options.previewIndex,
                    previewIndex = _a === void 0 ? 0 : _a,
                    _b = options.resizeType,
                    resizeType = _b === void 0 ? 'fill' : _b,
                    _c = options.quality,
                    quality = _c === void 0 ? 85 : _c,
                    width = options.width,
