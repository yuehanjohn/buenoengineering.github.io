...
var ProGalleryStore = /** @class */ (function() {
    function ProGalleryStore(_a) {
        var context = _a.context,
            ...
            callSetHeightControlMode = _a.callSetHeightControlMode,
            ...
            withWarmupData = _a.withWarmupData,
            setDirectFullscreenPropCallback = _a.setDirectFullscreenPropCallback,
            setDirectFullscreenMockPropCallback = _a.setDirectFullscreenMockPropCallback;
        var _this = this;
            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.trys.push([2, 4, , 5]);
                        return [4 /*yield*/ , this.withWarmupData(function() {
                            return _this.fetcher.getItemByIdFromServer(requestedItemId);
    ...
    ProGalleryStore.prototype.fixGalleryStyleRatiosInMobile = function() {
        ...
        if (this.isMobile &&
            ...
            var _c = this.baseMobileRatioStyles,
                gallerySize = _c.gallerySize,
                imageMargin = _c.imageMargin;
