...
var GalleryGroup = /** @class */ (function() {
    ...
    GalleryGroup.prototype.processScheme = function(scheme) {
        this.id = scheme.id;
        this.idx = scheme.idx;
    ...
    GalleryGroup.prototype.renderProps = function(galleryConfig) {
        return {
            className: 'group',
            id: this.id,
            idx: this.idx,
    ...
    Object.defineProperty(GalleryGroup.prototype, "key", {
        get: function() {
