...
var GalleryItem = /** @class */ (function() {
    ...
    GalleryItem.prototype.createSecondMediaItemIfNeeded = function(config) {
        var _a;
        if ((_a = config.dto) === null || _a === void 0 ? void 0 : _a.secondaryMedia) {
            this.secondaryMediaItem = new GalleryItem(this.mapItemConfig(config));
        }
    };
    GalleryItem.prototype.updateSecondaryMedia = function(config) {
        if (this.secondaryMediaItem) {
            this.secondaryMediaItem.update(this.mapItemConfig(config));
        }
    };
    GalleryItem.prototype.mapItemConfig = function(config) {
        var dto = {};
        Object.assign(dto, config.dto.secondaryMedia, config.dto.secondaryMedia.metadata);
        return __assign(__assign({}, config), {
            dto: dto,
            scheme: __assign(__assign({}, config.scheme), {
    ...
    GalleryItem.prototype.update = function(config) {
        ...
        this.sharpParams = __assign({}, config.sharpParams);
    ...
    GalleryItem.prototype.renderProps = function(config) {
        ...
        if (this.hasSecondaryMedia) {
            itemProps.secondaryMediaItem = __assign(__assign({}, this.secondaryMediaItem.renderProps()), {
    ...
    GalleryItem.prototype.processedMediaUrl = function(resizeMethod, requiredWidth, requiredHeight, sharpParams, createMultipleUrls) {
        var _this = this;
        var _a;
        if (createMultipleUrls === void 0) {
            createMultipleUrls = false;
        }
        var mediaUrl = function(item, url, resizeMethod, requiredWidth, requiredHeight, sharpParams, focalPoint) {
            if (sharpParams === void 0) {
                sharpParams = null;
            }
            ...
            var mediaUrl;
            if (typeof _this.createMediaUrl === 'function') {
                try {
                    var str = String(utils.hashCode(JSON.stringify({
                        url: url,
                    ...
                    mediaUrl = _this._cachedUrls[str];
                } catch (e) {
                    console.error('Cannot create url', e, item, url, resizeMethod, requiredWidth, requiredHeight, sharpParams, focalPoint);
                    mediaUrl = String(url);
                }
            } else {
                mediaUrl = String(url);
        ...
        var thumbSize = 250;
        var focalPoint = resizeMethod === GALLERY_CONSTS.resizeMethods.FILL &&
            this.isCropped &&
            this.focalPoint;
        var urls = {};
        var imgUrl = this.url;
        if (this.isText) {
            return Object.assign.apply(Object, __spreadArrays([{}], Object.values(GALLERY_CONSTS.urlTypes).map(function(value) {
                var _a;
                return (_a = {},
                    _a[value] = function() {
                        return '';
            ...
            if (utils.isExternalUrl(this.url)) {
                urls[GALLERY_CONSTS.urlTypes.VIDEO] = function() {
                    return _this.url;
                };
            } else {
                urls[GALLERY_CONSTS.urlTypes.VIDEO] = function() {
                    return mediaUrl(_this, _this.url, GALLERY_CONSTS.resizeMethods.VIDEO, requiredWidth, requiredHeight);
                };
            }
        }
        urls[GALLERY_CONSTS.urlTypes.HIGH_RES] = function() {
            return mediaUrl(_this, imgUrl, resizeMethod, requiredWidth, requiredHeight, sharpParams, focalPoint);
        };
        urls[GALLERY_CONSTS.urlTypes.LOW_RES] = function() {
            return mediaUrl(_this, imgUrl, _this.cubeImages && resizeMethod !== GALLERY_CONSTS.resizeMethods.FIT ?
                GALLERY_CONSTS.resizeMethods.FILL :
                GALLERY_CONSTS.resizeMethods.FIT, thumbSize, thumbSize, __assign(__assign({}, sharpParams), {
                    quality: 30,
                    blur: 30
                }), focalPoint);
        };
    ...
    GalleryItem.prototype.createMagnifiedUrl = function(scale) {
        if (scale === void 0) {
            scale = 1;
        }
        if (!this.urls.magnified_url) {
            var _a = this.style,
                innerWidth_1 = _a.innerWidth,
                innerHeight_1 = _a.innerHeight;
            this.urls.magnified_url = this.processedMediaUrl(this.cubeType, innerWidth_1 * scale, innerHeight_1 * scale, this.sharpParams, true);
        }
    ...
    Object.defineProperty(GalleryItem.prototype, "resized_url", {
        get: function() {
            if (!this.urls.resized_url) {
                this.urls.resized_url = this.processedMediaUrl(this.cubeType, this.resizeWidth, this.resizeHeight, this.sharpParams);
            }
    ...
    Object.defineProperty(GalleryItem.prototype, "multi_url", {
        get: function() {
            if (!this.urls.multi_url) {
                this.urls.multi_url = this.processedMediaUrl(this.cubeType, this.resizeWidth, this.resizeHeight, this.sharpParams, true);
            }
    ...
    Object.defineProperty(GalleryItem.prototype, "scaled_url", {
        get: function() {
            if (!this.urls.scaled_url) {
                ...
                this.urls.scaled_url = this.processedMediaUrl(GALLERY_CONSTS.resizeMethods.FILL, isOrgWider ? orgRatio * this.resizeHeight : this.resizeWidth, isOrgWider ? this.resizeHeight : this.resizeWidth / orgRatio, this.sharpParams);
            }
    ...
    Object.defineProperty(GalleryItem.prototype, "thumbnail_url", {
        get: function() {
            if (!this.urls.thumbnail_url) {
                this.urls.thumbnail_url = this.processedMediaUrl(GALLERY_CONSTS.resizeMethods.FILL, this.thumbnailSize, this.thumbnailSize, {
                    quality: 70
                });
            }
    ...
    Object.defineProperty(GalleryItem.prototype, "full_url", {
        get: function() {
            if (!this.urls.full_url) {
                this.urls.full_url = this.processedMediaUrl(GALLERY_CONSTS.resizeMethods.FULL, this.maxWidth, this.maxHeight, this.sharpParams);
            }
    ...
    Object.defineProperty(GalleryItem.prototype, "hasSecondaryMedia", {
        get: function() {
    ...
    Object.defineProperty(GalleryItem.prototype, "isCropped", {
        get: function() {
            return (this.cubeImages && this.cubeType === GALLERY_CONSTS.resizeMethods.FILL);
        },
        enumerable: false,
        configurable: true
    });
    ...
    Object.defineProperty(GalleryItem.prototype, "htmlContent", {
        get: function() {
            var _a;
            return (_a = this.html) === null || _a === void 0 ? void 0 : _a.replace(/<[^<>]*>/g, '').trim();
        },
        enumerable: false,
        configurable: true
    });
    ...
    Object.defineProperty(GalleryItem.prototype, "webLink", {
        get: function() {
            var _a;
            if (((_a = this.linkUrl) === null || _a === void 0 ? void 0 : _a.length) > 0 && this.linkType === 'web') {
                return {
                    url: this.linkUrl,
