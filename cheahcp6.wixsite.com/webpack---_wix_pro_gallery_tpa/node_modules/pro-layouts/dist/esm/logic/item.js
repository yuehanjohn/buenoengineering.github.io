...
var Item = /** @class */ (function() {
    ...
    Item.prototype.fixMetadataVerticalVideoRatio = function(metadata) {
        if (metadata.qualities && metadata.qualities[0]) {
            ...
            var _a = qualities[qualities.length - 1],
                height = _a.height,
                width = _a.width;
    ...
    Object.defineProperty(Item.prototype, "offset", {
        get: function() {
            ...
            var _b = this.dimensions,
                _c = _b.fixTop,
                fixTop = _c === void 0 ? 0 : _c,
                _d = _b.fixLeft,
                fixLeft = _d === void 0 ? 0 : _d,
                _e = _b.fixRight,
                fixRight = _e === void 0 ? 0 : _e,
                _f = _b.fixBottom,
                fixBottom = _f === void 0 ? 0 : _f;
            ...
            if (this.scatter > 0 || ((_a = this.rotatingScatter) === null || _a === void 0 ? void 0 : _a.length) > 0) {
                var _g = this.calcScatter(offset),
                    x = _g.x,
                    y = _g.y;
                offset.left += x;
                offset.top += y;
    ...
    Object.defineProperty(Item.prototype, "width", {
        ...
        set: function(w) {
            ...
            var _a = this.dimensions,
                _b = _a.fixLeft,
                fixLeft = _b === void 0 ? 0 : _b,
                _c = _a.fixRight,
                fixRight = _c === void 0 ? 0 : _c;
    ...
    Object.defineProperty(Item.prototype, "height", {
        ...
        set: function(h) {
            ...
            var _a = this.dimensions,
                _b = _a.fixTop,
                fixTop = _b === void 0 ? 0 : _b,
                _c = _a.fixBottom,
                fixBottom = _c === void 0 ? 0 : _c;
    ...
    Object.defineProperty(Item.prototype, "roundedStyle", {
        get: function() {
            return __assign(__assign({}, this.style), {
