...
var Layouter = /** @class */ (function() {
    ...
    Layouter.prototype.prepareLayoutParams = function() {
        ...
        if (this.useExistingLayout && this.pointer > 0) {
            ...
            this.targetItemSize = this.styleParams.isVertical ?
                ...
                this.targetItemSize;
            var _a = this.styleParams,
                columnWidths = _a.columnWidths,
                externalInfoWidth_1 = _a.externalInfoWidth,
                imageMargin_1 = _a.imageMargin;
            ...
            if (columnWidths && columnWidths.length > 0) {
                ...
                var columnMultiplier_1 = this.galleryWidth / columnWidthsArr_1.reduce(function(a, b) {
                    return a + b;
                }, 0);
    ...
    Layouter.prototype.getMaxGroupSize = function() {
        ...
        try {
            ...
            _maxGroupSize =
                groupTypes.length > 0 ?
                groupTypes.reduce(function(curSize, groupType) {
