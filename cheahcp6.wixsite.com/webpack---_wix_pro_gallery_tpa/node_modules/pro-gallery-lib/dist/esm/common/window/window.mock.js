...
var elem = __assign(__assign({}, dimsMock), {
...
export var scrollMock = {
    scrollTop: 0,
    scrollY: 0,
};
var windowHydrateMock = __assign(__assign({}, dimsMock), scrollMock);
...
export var hydrateMockMap = new Map(Object.keys(windowHydrateMock).map(function(key) {
    return [key, windowHydrateMock[key]];
}));
