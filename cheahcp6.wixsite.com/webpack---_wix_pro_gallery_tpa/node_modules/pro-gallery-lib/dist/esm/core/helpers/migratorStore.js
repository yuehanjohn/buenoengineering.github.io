...
export var nameChangedLayoutParams = [
...
export var reversedLayoutParams = [
    ['useMaxDimensions', optionsMap.layoutParams.structure.enableStreching],
];
export var nameChangedBehaviourParams = [
    [
        'magnificationLevel',
...
export var reversedBehaviourParams = [
    [
    ...
    ['enableScroll', optionsMap.behaviourParams.gallery.horizontal.blockScroll],
];
export var nameChangedStylingParams = [
...
export function changeNames(obj, pairsArray) {
    ...
    for (var _i = 0, pairsArray_1 = pairsArray; _i < pairsArray_1.length; _i++) {
        var _a = pairsArray_1[_i],
            oldName = _a[0],
            newName = _a[1];
...
export function reverseBooleans(obj, pairsArray) {
    var _obj = __assign({}, obj);
    for (var _i = 0, pairsArray_2 = pairsArray; _i < pairsArray_2.length; _i++) {
        var _a = pairsArray_2[_i],
            oldName = _a[0],
            newName = _a[1];
...
//# sourceMappingURL=migratorStore.js.map