...
function getTextBoxRightOrLeftWidth(options, customExternalInfoRendererExists) {
    ...
    var calculateTextBoxWidthMode = options.calculateTextBoxWidthMode,
        textBoxWidth = options.textBoxWidth,
        textBoxWidthPercent = options.textBoxWidthPercent;
    var width = 0;
...
function shouldShowTextRightOrLeft(options, customExternalInfoRendererExists) {
    ...
    var allowedByLayoutConfig = scrollDirection === GALLERY_CONSTS.scrollDirection.VERTICAL &&
        isVertical &&
        groupSize === 1;
...
function shouldShowTextBoxAboveOrBelow(options, customExternalInfoRendererExists) {
    return (hasExternalVerticalPlacement(options.titlePlacement) &&
        customExternalInfoRendererExists);
}
