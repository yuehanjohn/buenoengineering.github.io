...
function process_old_to_new_columnRatios(obj) {
    ...
    if (((_a = _obj[optionsMap.layoutParams.structure.columnRatios]) === null || _a === void 0 ? void 0 : _a.length) === 0) {
        ...
        _obj[optionsMap.layoutParams.structure.columnRatios] = _obj[optionsMap.layoutParams.structure.columnRatios] ?
            ((_b = _obj[optionsMap.layoutParams.structure.columnRatios]) === null || _b === void 0 ? void 0 : _b.split) ? __spreadArrays((_c = _obj[optionsMap.layoutParams.structure.columnRatios]) === null || _c === void 0 ? void 0 : _c.split(',').map(Number)) : _obj[optionsMap.layoutParams.structure.columnRatios] :
            undefined;
    }
    return _obj;
}
...
function process_old_to_new_cropMethod(obj) {
    ...
    _obj[optionsMap.layoutParams.crop.method] = (_a = _obj[optionsMap.layoutParams.crop.method]) === null || _a === void 0 ? void 0 : _a.toUpperCase();
    return _obj;
}
...
function process_old_to_new_ThumbnailAlignment(obj) {
    ...
    _obj[optionsMap.layoutParams.thumbnails.alignment] = (_a = _obj[optionsMap.layoutParams.thumbnails.alignment]) === null || _a === void 0 ? void 0 : _a.toUpperCase();
    return _obj;
}
...
function process_old_to_new_VideoPlayTrigger(obj) {
    ...
    _obj[optionsMap.behaviourParams.item.video.playTrigger] = (_a = _obj[optionsMap.behaviourParams.item.video.playTrigger]) === null || _a === void 0 ? void 0 : _a.toUpperCase();
    return _obj;
}
...
function process_old_to_new_galleryTextAlign(obj) {
    ...
    _obj[optionsMap.behaviourParams.gallery.horizontal.slideshowInfo.buttonsAlignment] = (_a = _obj[optionsMap.behaviourParams.gallery.horizontal.slideshowInfo
...
function process_old_to_new_LoadMoreAmount(obj) {
    ...
    _obj[optionsMap.behaviourParams.gallery.vertical.loadMore.amount] = (_a = _obj[optionsMap.behaviourParams.gallery.vertical.loadMore.amount]) === null || _a === void 0 ? void 0 : _a.toUpperCase();
    return _obj;
}
...
function process_old_to_new_ClickAction(obj) {
    ...
    _obj[optionsMap.behaviourParams.item.clickAction] = (_a = _obj[optionsMap.behaviourParams.item.clickAction]) === null || _a === void 0 ? void 0 : _a.toUpperCase();
...
function process_old_to_new_AllowedGroupTypes(obj) {
    ...
    var _obj = obj;
    _obj[optionsMap.layoutParams.groups.allowedGroupTypes] = ((_a = _obj['groupTypes']) === null || _a === void 0 ? void 0 : _a.split) ? _obj['groupTypes'].split(',') :
        _obj['groupTypes'] ?
        _obj['groupTypes'] :
        undefined;
