...
export var fixedOptions = fixToMasonry({});
export var createOptions = function(options) {
    var res = __assign({}, options);
    res = fixToMasonry(res);
    res.targetItemSize = calcTargetItemSize(res, res.isVertical ? res.gallerySize * 8 + 200 : res.gallerySize * 5 + 200);
