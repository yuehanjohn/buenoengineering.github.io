...
import {
    featureManager
} from '../helpers/versionsHelper';
import {
    assignByString
} from '../helpers/optionsUtils';
var fixToMagic = function(options) {
    ...
    presetOptions = assignByString(presetOptions, 'layoutParams_cropRatio', undefined);
    ...
    presetOptions = assignByString(presetOptions, 'layoutParams_gallerySpacing', undefined);
...
export var fixedOptions = fixToMagic({});
var addSeedOptions = function(options) {
    ...
    res = assignByString(res, 'layoutParams_cropRatio', numFromSeed(1, 25, 'cubeRatio') / 5);
    ...
    res.imageMargin = numFromSeed(0, featureManager.supports.spacingCalculation ?
        numFromSeed(300, 800, 'gallerySize') / 5 :
        5, 'imageMargin');
    res = assignByString(res, 'layoutParams_gallerySpacing', featureManager.supports.spacingCalculation ?
        0 :
