...
import {
    createOptions as jsonFixedOptions
} from './designedPresetGallery';
import {
    addMigratedOptions
} from '../helpers/optionsConverter';
import {
    flattenObject
} from '../helpers/optionsUtils';
//#endregion Imports
var addPresetOptions = function(options) {
    var galleryType = options.galleryType;
    var galleryLayoutV1 = options.galleryType;
    var galleryLayoutV2 = options.galleryLayout;
...
var isInPreset = function(galleryLayout, paramToCheck) {
    ...
    return Object.keys(addMigratedOptions(flattenObject(NEW_PRESETS[layoutName]))).includes(paramToCheck);
};
export {
    addPresetOptions,
    NEW_PRESETS,
