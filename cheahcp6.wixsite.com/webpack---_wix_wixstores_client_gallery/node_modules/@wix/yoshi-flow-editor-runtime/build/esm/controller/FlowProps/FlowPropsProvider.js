...
var FlowPropsProvider = /** @class */ (function(_super) {
    ...
    function FlowPropsProvider(_a) {
        ...
        var flowAPI = _a.flowAPI,
            ...
            configs = __rest(_a, ["flowAPI", "panoramaClient"]);
    ...
    FlowPropsProvider.prototype.initControllerProps = function(_a) {
        ...
        if (flowAPI.panoramaClient) {
            var _g = panoramaClientProps(flowAPI.panoramaClient),
                transactionWithAction = _g.transactionWithAction,
                errorMonitorWithOptions = _g.errorMonitorWithOptions,
                logger = _g.logger;
